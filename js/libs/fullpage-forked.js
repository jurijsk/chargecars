...
(function(global, factory) {
  ...
  $.fn.fullpage = function(options) {
      ...
      options = $.extend({
          ...
          customMouseWheelHandler: null,
          customKeyDownHandler: null,
          customTouchMoveHandler: null,
      ...
      function styleSlides(section, slides, numSlides){
          ...
          section.find(SLIDES_CONTAINER_SEL).css('width', '100%');
          ...
          if( startingSlide.length &&  ($(SECTION_ACTIVE_SEL).index(SECTION_SEL) !== 0 || ($(SECTION_ACTIVE_SEL).index(SECTION_SEL) === 0 && startingSlide.index() !== 0))){
              ...
              slides.eq(0).addClass(ACTIVE).addClass('animated');
          }
      }
      ...
      */
          ...
          if (isReallyTouch(e) ) {
              ...
              //vertical scrolling (only when autoScrolling is enabled)
                  ...
                  if (Math.abs(touchStartY - touchEndY) > ($window.height() / 100 * options.touchSensitivity)) {
                      $.isFunction(options.customTouchMoveHandler) && options.customTouchMoveHandler.call(container, [scrolling,
                          touchStartY > touchEndY ? 'down' : touchEndY > touchStartY && 'up', activeSection]);
                  }
              }
          }
      }
          ...
          if (options.autoScrolling && !controlPressed && !isNormalScroll) {
              ...
              if (canScroll) {
                  ...
                  if (isAccelerating && isScrollingVertically) {
                      $.isFunction(options.customMouseWheelHandler) && options.customMouseWheelHandler.call(container, [scrolling, delta < 0 ? 'down' : 'up']);
                  }
              }
      ...
      function setSrc(element, attribute){
        if (attribute == 'bg') {
            element
                .css('backgroundImage', 'url("' + element.data(attribute) + '")')
      ...
      function lazyLoad(destiny){
          ...
          panel.find('img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src], *[data-slide-type]').each(function(){
              element = $(this);

              $.each(['src', 'srcset', 'bg'], function(index, type){
      ...
      function keydownHandler(e) {
          ...
          if(keyCode === 9){
              ...
              $.isFunction(options.customKeyDownHandler) && options.customKeyDownHandler.call(container, [defaultKeyDownHandler, (keyCode == 32 || keyCode == 34 || keyCode == 40) ? 'down' : ((keyCode == 33 || keyCode == 38) ? 'up' : '')]);
          }
      }
      ...
      function landscapeScroll(slides, destiny, direction){
          ...
          destiny.addClass('animated')
          setTimeout(function(){
                destiny.siblings(':not(.active)').removeClass('animated')
          }, 700);
      ...
      */
      function destroyStructure(){
          ...
          container.find('*[data-bg]').each(function(){
            setSrc($(this), 'bg');
        });
