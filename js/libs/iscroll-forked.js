/* Iscroll probe fork for working with fullpage */
        ...
        */
        ...
        function scrollBarHandler(){
            ...
            */
            function createScrollBar(element){
                let scrolled_element = element.find('*[data-scroll]');
                ...
                var wrap = scrollOverflowHandler.wrapContent(element.closest('*[data-section]').attr('id'));
                ...
                if ( contentHeight > scrollHeight) {
                    ...
                    //creating the scrolling
                        ...
                        if(self.options.verticalCentered){
                            element.find('*[data-scroll]').wrapInner(wrap);
                        }else{
        ...
        var iscrollHandler = {
            ...
            */
             ...
             */
            wrapContent: function(section = '') {
                return '<div class="' + SCROLLABLE + '"><div class="fp-scroller" data-parent-section="' + section + '"></div></div>';
            }
        };
